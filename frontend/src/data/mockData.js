...
export const mockBenchCandidates = [
  {
    id: 1,
    name: 'John Smith',
    primaryRole: 'Senior Java Developer',
    experience: '8+ years',
    status: 'Available',
    skills: ['Java', 'Spring Boot', 'Microservices', 'AWS', 'Docker', 'Kubernetes']
  },
  {
    id: 2,
    name: 'Sarah Johnson',
    primaryRole: 'React Frontend Engineer',
    experience: '5+ years',
    status: 'Available',
    skills: ['React', 'TypeScript', 'Redux', 'Next.js', 'Tailwind CSS', 'GraphQL']
  },
  {
    id: 3,
    name: 'Michael Chen',
    ...
    experience: '7+ years',
    status: 'Interviewing',
    skills: ['AWS', 'Terraform', 'Jenkins', 'Docker', 'Kubernetes', 'Python']
  },
  {
    id: 4,
    name: 'Emily Rodriguez',
    primaryRole: 'Full Stack .NET Developer',
    experience: '6+ years',
    status: 'Available',
    skills: ['.NET Core', 'C#', 'Azure', 'SQL Server', 'Angular', 'REST API']
  }
];
